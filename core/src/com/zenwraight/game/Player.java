...
public class Player extends Group implements PhysicsBody{
    ...
    public float BAT_FLAP_POWER = 8f;
    public float BAT_MAX_VEL_CAP = 8f;
    public float BAT_MAX_VEL_Y = 8f;
    public float BAT_MAX_VEL_X = 8f;
    ...
    public Player(GameStage stage) {
        this.stage = stage;
        bat = new Entity(stage, Res.createSprite("bat0"));
        bat.setSize(32f, 32f);
        batFrames = new TextureRegion[]{Res.findRegion("bat0"), Res.findRegion("bat1")};
