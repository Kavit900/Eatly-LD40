...
public class Gui extends Stage{
    ...
    public Gui(GameScreen screen) {
        ...
        heartRegions = new TextureRegion[]{Res.findRegion("heart0"), Res.findRegion("heart1")};

        health = new Group();
        heart0 = new Entity(null, Res.createSprite("heart0"));
        heart1 = new Entity(null, Res.createSprite("heart0"));
        heart2 = new Entity(null, Res.createSprite("heart0"));
        ...
        foods = new Group();
        foods.setPosition(0f, getHeight() - 20f);
        addActor(foods);
    }

    public void foodCollected(Food moth) {
        int c = foods.getChildren().size;
