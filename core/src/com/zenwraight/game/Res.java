...
public class Res {
    ...
    public static BitmapFont fontRules;
    public static void load() {
        ...
        FreeTypeFontGenerator gen = new FreeTypeFontGenerator(Gdx.files.internal("pressstart.ttf"));
        ...
        FreeTypeFontGenerator.FreeTypeFontParameter par1 = new FreeTypeFontGenerator.FreeTypeFontParameter();
        par1.size = 6;
        par1.kerning = true;
        par1.minFilter = Texture.TextureFilter.Nearest;
        par1.magFilter = Texture.TextureFilter.Nearest;
        fontRules = gen.generateFont(par1);
    }
